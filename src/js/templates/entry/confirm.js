...
function EntryConfirmTable(props) {
  return (
    <Form className="form-confirm entry-confirm" action="#" method="post">
      ...
      <Button className="submit-button" size="small" nativeType="submit">会員登録をする</Button>
      </div>
    </Form>
  );
}
